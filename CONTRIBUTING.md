...
Ready to contribute? Here's how to set up `decide-dotnet` for local development.

# Contribution
## Setup Project
The link for this projects's repository can be found [here](decide-dotnet.git)
### Cloning the project

##### For HTTPS
Use this command `git clone https://github.com/indicina-dev/decide-dotnet.git`

##### For SSH
Use this command `git clone git@github.com:indicina-dev/decide-dotnet.git`

#### Running the project
- Create virtual enviroment
- Install the requirements.txt file `dotnet build`
- Create a new project or open an existing project where you want to use the library
- Add a reference to the built library
- Once the library reference is added, you can use the library's classes, methods, and functionality in your target project by importing the necessary namespaces or classes.
